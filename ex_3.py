...
class CameraThread3(QThread):
    ...
    def __init__(self, difficulty, speed, background):
        super().__init__()
    ...
    def run(self):
        ...
        while cap.isOpened() and self.rounds < self.difficulty and not self.stop_flag:
            ...
            self.animation_frame_index += 1  # Увеличиваем индекс кадра анимации
            self.animation_frame_index %= max(1, rain_frame_count, fog_frame_count, snow_frame_count)  # Сбрасываем индекс
